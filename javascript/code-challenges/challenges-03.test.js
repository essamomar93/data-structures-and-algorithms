...
const typeNum = (arr) => {
  ...
  let filterNumber= arr.filter(num=> typeof num === "number");
  return filterNumber;
...
const containsAnd = (arr) => {
  // Solution code here...
  let filterAnd= arr.filter(and => and.includes('and'));
  return filterAnd;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let secondArray= arr.filter(element=>! forbiddenValues.includes(element));
  return secondArray;
};
